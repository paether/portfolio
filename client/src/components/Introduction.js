    ...
    <section id="about" className="intro-container" ref={introContainer}>
      ...
      <div className="description">
        ...
        <p>
          ...
          knew I got hooked an there was no turning back. It has everything I
          have looked for — things to try out constantly, express my creativity
          and endless challenges to keep my mind occupied — thus I have decided
          to transition it into my job as well.
        </p>
        <p>
